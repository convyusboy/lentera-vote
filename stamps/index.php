<html>
<head>
	<title>Lentera-Vote - Stamps</title>
...
<body>
	<div id="wrap">
		...
		<div id="content">
			<?php
			$url = 'http://api.pemiluapi.org/stamps/api/stamps?apiKey=fea6f7d9ec0b31e256a673114792cb17';
			$ch = curl_init($url);
			...
			// echo $result;
			foreach ($arr['data']['results']['stamps'] as $a) {
				?>
				<div class="img">
					<a target="blank" href="<?= $a['url_large']?>">
						<img src="<?= $a['url_small']?>" width="100" height="100">
					</a>
					<div class="desc"><?php echo $a['text'] ?></div>
				</div>
				<?php
			}
